...
public interface DeviceCommandRepository extends JpaRepository<DeviceCommand, Long> {
    ...
    Optional<DeviceCommand> findTop1ByDeviceAndCommandTypeOrderByCreatedAtDesc(
            Device device, CommandType commandType);

    List<DeviceCommand> findByDevice(Device device);

    List<DeviceCommand> findTop10ByDeviceAndCommandTypeOrderByCreatedAtDesc(
            Device device, CommandType commandType);
}
